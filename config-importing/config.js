...
var API_PASSWORD = process.env.API_PASSWORD;
var SERVICE_API_PORT = process.env.SERVICE_API_PORT;
var API_PATH = process.env.API_PATH;
var API_USERNAME = process.env.API_USERNAME;
var INSECURE = process.env.INSECURE;
var CALLER_ID = process.env.CALLER_ID;
switch (CALLER_ID) {
  ...
  case "openhim_config_importer":
    const jsonData = JSON.parse(fs.readFileSync(path.resolve(__dirname, "openhim-import.json")));

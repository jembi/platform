...
METASTORE_CLUSTER = os.getenv('SUPERSET_POSTGRESQL_CLUSTER')
SQLALCHEMY_DATABASE_URI = f'postgresql://{METASTORE_USERNAME}:{METASTORE_PASSWORD}@{METASTORE_CLUSTER}/{METASTORE_DATABASE}'

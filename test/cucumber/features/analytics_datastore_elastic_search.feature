Feature: Analytics Datastore ElasticSearch?
    ...
    Scenario: Init Analytics Datastore ElasticSearch
        Given I use parameters "init analytics-datastore-elastic-search --dev --env-file=.env.local"
    ...
    Scenario: Destroy Analytics Datastore ElasticSearch
        Given I use parameters "destroy analytics-datastore-elastic-search --dev --env-file=.env.local"
        When I launch the platform with params

Feature: Identity Access Manager Keycloak?
    ...
    Scenario: Init Identity Access Manager Keycloak
        Given I use parameters "init identity-access-manager-keycloak --dev --env-file=.env.cluster"
    ...
    Scenario: Destroy Identity Access Manager Keycloak
        Given I use parameters "destroy identity-access-manager-keycloak --dev --env-file=.env.cluster"
        When I launch the platform with params

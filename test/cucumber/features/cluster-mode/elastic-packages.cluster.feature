Feature: Analytics Datastore Elasticsearch - Dashboard Visualiser Kibana - Data Mapper Logstash ?
    ...
    Scenario: Init Dashboard Visualiser Kibana
        ...
        Then The service "analytics-datastore-elastic-search-01" should be started
        And The service "analytics-datastore-elastic-search-02" should be started
        And The service "analytics-datastore-elastic-search-03" should be started

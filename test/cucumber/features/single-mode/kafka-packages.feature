Feature: Kafka and its dependent packages?
    ...
    Scenario: Init Message Bus Kafka
        ...
        And The service "kafka" should be started with 1 replicas
    ...
    Scenario: Init Kafka Mapper Consumer
        ...
        When I launch the platform with params
        Then The service "kafka-mapper-consumer" should be started with 1 replicas

    Scenario: Init Message Bus Kafka
        Given I use parameters "init kafka-unbundler-consumer --only --dev --env-file=.env.local"
        When I launch the platform with params
        Then The service "kafka-unbundler-consumer" should be started with 1 replicas
